...
// revisar
    pg_query($conexion, "INSERT INTO psg_movimiento (id_material,id_entrada,id_salida,cantidad,motivo_movimiento,tipo_movimiento,fecha_movimiento) VALUES($params->id_material,$params->id_entrada,$params->id_salida,$params->cantidad,'$params->motivo_movimiento','$params->tipo_movimiento','$params->fecha_movimiento')");
