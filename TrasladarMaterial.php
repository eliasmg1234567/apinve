...
// revisar
    pg_query($conexion, "INSERT INTO psg_movimiento (id_material,id_origen,id_destino,cantidad,motivo_movimiento,tipo_movimiento,fecha_movimiento) VALUES($params->id_material,$params->id_origen,$params->id_destino,$params->cantidad,'$params->motivo_movimiento','$params->tipo_movimiento','$params->fecha_movimiento')");
